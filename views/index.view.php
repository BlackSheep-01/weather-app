...
<body>
    <?php 
        $backgrounds= [
            "stormy"=> "Design/SVGs/stormy/bg.svg",
            "cloudy"=> "Design/SVGs/cloudy/bg.svg",
            "snowy"=> "Design/SVGs/snowy/bg.svg",
            "sunny"=> "Design/SVGs/sunny/bg.svg"
        ];
        $bgImage= null;
    ...
    >
        ...
        <div class="weather_info">
            <?php 
            $images= [
                "stormy"=> "Design/SVGs/stormy/large.svg",
                "cloudy"=> "Design/SVGs/cloudy/large.svg",
                "snowy"=> "Design/SVGs/snowy/large.svg",
                "sunny"=> "Design/SVGs/sunny/large.svg"
            ];
            $largeImage= null;
            ...
            <?php if( !empty($largeImage) ): ?>
                <img src="<?= $largeImage ?>" alt="<?= $info->weatherType ?>" class="weather_info_img">
            <?php endif ?>

            <h1 class="weather_info_temperature"><?= e($info->temperatureC) ?>&deg;C</h1>

            <?php if($info->weatherType === "stormy"): ?>
                <p class="weather_info_description">
            ...
            <p class="humidity">Humidity: <?= e($info->humidity) ?> </p>
            <p class="uvindex">UV Index: <?= e($info->uvIndex) ?> </p>
        </div>
